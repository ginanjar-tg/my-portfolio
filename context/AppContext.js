...
const translations = {
  en: {
    ...
    present: "Present",
    webDesktopDev: "Web and desktop application development for various clients",
  ...
  id: {
    ...
    present: "Sekarang",
    webDesktopDev: "Pengembangan aplikasi web dan desktop untuk berbagai klien",
    backendIntern: "Backend Developer Intern",
  ...
  zh: {
    ...
    present: "至今",
    webDesktopDev: "为各种客户开发网络和桌面应用程序",
